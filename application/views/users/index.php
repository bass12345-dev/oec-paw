...
<head>
     ...
     <?php $this->load->view('users/includes/meta.php'); ?>
    <?php $this->load->view('users/includes/css.php'); ?>
...
<!--begin::Body-->
    ...
    <body id="kt_body" style="background-image: url(assets/media/patterns/header-bg.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                        ...
                        <div class="container-xxl d-flex align-items-center">
                            ...
                            $this->load->view('users/includes/header_logo.php');

                            ?>
                            <!--end::Header Logo-->
                            <!--begin::Wrapper-->
                            <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                                <?php $this->load->view('users/includes/navbar.php') ?>
                  ...
                  <!--   footer -->
                   ...
                   <?php $this->load->view('users/includes/footer.php'); ?>
        ...
        <!--begin::Drawers-->
         ...
         <?php $this->load->view('users/includes/drawer'); ?>
     ...
     <?php $this->load->view('users/includes/scroll_to_top.php'); ?>
    <!--end::Main-->
    <?php $this->load->view('users/includes/scripts.php'); ?>
