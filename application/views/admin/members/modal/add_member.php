                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    <!--begin::Form-->
                                                    <form id="add_member_form" class="form" action="#">
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll"
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="member_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" required="" value="" />
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <label class="required fw-bold fs-6 mb-2">Position</label>
                                                                 ...
                                                                 <select class="form-control form-control-solid mb-3 mb-lg-0" name="position">
                                                              ...
                                                              <div class="fv-row mb-7">
                                                                ...
                                                                <label class="required fw-bold fs-6 mb-2">Type</label>
                                                                 ...
                                                                 <?php
                                                                    foreach($this->config->item('type') as $row):
                                                                      echo '
                                                                        <option value="'.$row.'">'.$row.'</option> 
                                                                      ';
                                                                    endforeach;
