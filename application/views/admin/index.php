...
<!--  -->
                        ...
                        <div class="content flex-row-fluid" id="kt_content">
                            ...
                            <div class="card card-page">
                                ...
                                <div class="card-body">
                                    ...
                                    $this->load->view('admin/welcome/index');
                                      $this->load->view('admin/home/index');
                                    $this->load->view('admin/members/index');
                                    $this->load->view('admin/singers/index');
                                    $this->load->view('admin/artist/index');
                                    $this->load->view('admin/setlist/index');
        ...
        <!--begin::Drawers-->
         ...
         <?php $this->load->view('modals/update_contact'); ?>
         <?php $this->load->view('admin/home/modals/add_gigs_modal'); ?>
         <?php $this->load->view('includes/drawer'); ?>

          <?php $this->load->view('admin/setlist/drawer/shuffle_drawer'); ?>
           <?php $this->load->view('admin/setlist/drawer/shuffled_songs_drawer'); ?>
            <?php $this->load->view('admin/setlist/drawer/setlist_drawer'); ?>

            <?php $this->load->view('admin/setlist/drawer/create_setlist_drawer'); ?>
