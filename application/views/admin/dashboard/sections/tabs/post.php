<!--begin::Tab panel-->
												<div id="kt_activity_month" class="card-body p-0 tab-pane fade show" role="tabpanel" aria-labelledby="kt_activity_month_tab">
													...
													<?php $this->load->view('admin/dashboard/sections/create_post'); ?>
													...
													<div class="timeline" style="margin-top: 20px">
														...
														<div class="timeline-item">
															...
															<div class="timeline-content mb-10 mt-n1">
																...
																<div class="pe-3 mb-5">
																	<!--begin::Title-->
																	<div class="fs-5 fw-bold mb-2">asd3 new application design concepts added:</div>
																	<!--end::Title-->
																	<!--begin::Description-->
																	...
																	<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
																		...
																		<div class="overlay me-10">
																			...
																			<div class="overlay-wrapper">
																				<img alt="img" class="rounded w-100px" src="/ceres-html-free/assets/media/stock/300x270/1.jpg" />
																			</div>
																			<!--end::Image-->
																			<!--begin::Link-->
																		...
																		<div class="overlay me-10">
																			<!--begin::Image-->
																			<div class="overlay-wrapper">
																				<img alt="img" class="rounded w-100px" src="/ceres-html-free/assets/media/stock/300x270/2.jpg" />
																			</div>
																			<!--end::Image-->
																			<!--begin::Link-->
																			<div class="overlay-layer bg-dark bg-opacity-10 rounded">
																		...
																		<div class="overlay">
																			<!--begin::Image-->
																			<div class="overlay-wrapper">
																				<img alt="img" class="rounded w-100px" src="/ceres-html-free/assets/media/stock/300x270/3.jpg" />
																			</div>
																			<!--end::Image-->
																			<!--begin::Link-->
																			<div class="overlay-layer bg-dark bg-opacity-10 rounded">
														...
														<div class="timeline-item">
															...
															<div class="timeline-content mb-10 mt-n1">
																...
																<div class="pe-3 mb-5">
																	<!--begin::Title-->
																	<div class="fs-5 fw-bold mb-2">asdNew case 
																...
																<div class="overflow-auto pe-3">
																	...
																	<div class="d-flex align-items-center mt-1 fs-6">
																		...
																		<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
																			<img src="/ceres-html-free/assets/media/avatars/150-2.jpg" alt="img" />
																		</div>
																		<!--end::User-->
																	</div>
																	<!--end::Description-->
																...
																<div class="mb-5 pe-3">
																	...
																	<div class="d-flex align-items-center mt-1 fs-6">
																		...
																		<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
																			<img src="/ceres-html-free/assets/media/avatars/150-6.jpg" alt="img" />
																		</div>
																		<!--end::User-->
																	</div>
																	<!--end::Description-->
																...
																<div class="overflow-auto pb-5">
																	<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
																		...
																		<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
																			<!--begin::Icon-->
																			<img alt="" class="w-30px me-3" src="/ceres-html-free/assets/media/svg/files/pdf.svg" />
																			<!--end::Icon-->
																			<!--begin::Info-->
																		...
																		<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
																			<!--begin::Icon-->
																			<img alt="" class="w-30px me-3" src="/ceres-html-free/assets/media/svg/files/doc.svg" />
																			<!--end::Icon-->
																			<!--begin::Info-->
																			<div class="ms-1 fw-bold">
																				<!--begin::Desc-->
																		...
																		<div class="d-flex flex-aligns-center">
																			<!--begin::Icon-->
																			<img alt="" class="w-30px me-3" src="/ceres-html-free/assets/media/svg/files/css.svg" />
																			<!--end::Icon-->
																			<!--begin::Info-->
																			<div class="ms-1 fw-bold">
																				<!--begin::Desc-->
