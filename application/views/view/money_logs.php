                                ...
                                <div class="flex-lg-row-fluid ms-lg-10">
                                    ...
                                    <div class="card mb-5 mb-xl-10" id="suggested-songs">
                                        ...
                                        <div class="card-header border-0 pt-5 pb-3">
                                            <!--begin::Card title-->
                                            <h3 class="card-title fw-bolder text-gray-800 fs-2">Money Logs</h3>
                                            <!--end::Card title-->
                                            <!--begin::Card toolbar-->
                                        ...
                                        <div class="card-body py-0">
                                            ...
                                            <div class="table-responsive">
                                                      ...
                                                      <table class="table align-middle table-row-dashed fs-6 gy-5" id="money_log_table">
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                          ...
                                          <!--   <th class="min-w-125px text-gray-800">Table</th> -->
                                            <th class="min-w-125px text-gray-800">Description</th>
                                             <th class="min-w-125px text-gray-800">Amount</th>
                                             <th class="min-w-125px text-gray-800">Date</th>
